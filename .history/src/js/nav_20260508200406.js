      ...
      <nav id="navbar" class="navbar fixed top-0 left-0 right-0 z-[1000] py-4 bg-transparent transition-all duration-300 border-b border-transparent">
        <div class="max-w-[1200px] mx-auto px-6 flex items-center justify-between">
          ...
          <div class="nav-links hidden md:flex gap-8 items-center" id="nav-links">
            <a href="/index.html" class="nav-link text-[0.9rem] font-medium text-gray-400 light:text-gray-600 hover:text-white light:hover:text-gray-900 transition-colors relative after:content-[''] after:absolute after:-bottom-1 after:left-0 after:w-0 after:h-[2px] after:bg-[#00d2ff] hover:after:w-full after:transition-all after:duration-300">Home</a>
            <a href="/services.html" class="nav-link text-[0.9rem] font-medium text-gray-400 light:text-gray-600 hover:text-white light:hover:text-gray-900 transition-colors relative after:content-[''] after:absolute after:-bottom-1 after:left-0 after:w-0 after:h-[2px] after:bg-[#00d2ff] hover:after:w-full after:transition-all after:duration-300">Services</a>
            <a href="/about.html" class="nav-link text-[0.9rem] font-medium text-gray-400 light:text-gray-600 hover:text-white light:hover:text-gray-900 transition-colors relative after:content-[''] after:absolute after:-bottom-1 after:left-0 after:w-0 after:h-[2px] after:bg-[#00d2ff] hover:after:w-full after:transition-all after:duration-300">About</a>
            <a href="/process.html" class="nav-link text-[0.9rem] font-medium text-gray-400 light:text-gray-600 hover:text-white light:hover:text-gray-900 transition-colors relative after:content-[''] after:absolute after:-bottom-1 after:left-0 after:w-0 after:h-[2px] after:bg-[#00d2ff] hover:after:w-full after:transition-all after:duration-300">Process</a>
            <a href="/testimonials.html" class="nav-link text-[0.9rem] font-medium text-gray-400 light:text-gray-600 hover:text-white light:hover:text-gray-900 transition-colors relative after:content-[''] after:absolute after:-bottom-1 after:left-0 after:w-0 after:h-[2px] after:bg-[#00d2ff] hover:after:w-full after:transition-all after:duration-300">Clients</a>
            <a href="/contact.html" class="nav-link text-[0.9rem] font-medium text-gray-400 light:text-gray-600 hover:text-white light:hover:text-gray-900 transition-colors relative after:content-[''] after:absolute after:-bottom-1 after:left-0 after:w-0 after:h-[2px] after:bg-[#00d2ff] hover:after:w-full after:transition-all after:duration-300">Contact</a>
          </div>
          <div class="flex items-center gap-4 z-10 relative">
            <button class="theme-toggle w-[38px] h-[38px] rounded-full bg-white/5 light:bg-black/5 border border-white/10 light:border-black/10 flex items-center justify-center text-[#00d2ff] transition-all duration-300 hover:border-[#00d2ff] hover:shadow-[0_0_15px_rgba(0,210,255,0.4)] backdrop-blur-md" id="theme-toggle" aria-label="Toggle theme">
            ...
            <button class="nav-toggle flex md:hidden flex-col gap-[5px]" id="nav-toggle" aria-label="Toggle menu">
              <span class="w-6 h-[2px] bg-white light:bg-black rounded-full transition-all duration-300"></span>
              <span class="w-6 h-[2px] bg-white light:bg-black rounded-full transition-all duration-300"></span>
              <span class="w-6 h-[2px] bg-white light:bg-black rounded-full transition-all duration-300"></span>
            </button>
          </div>
