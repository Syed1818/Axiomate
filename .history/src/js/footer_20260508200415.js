        ...
        <div class="max-w-7xl mx-auto">
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[1.5fr_1fr_1fr_1fr] gap-10 mb-12">
            ...
            <div class="flex flex-col gap-3">
              ...
              <a href="https://linkedin.com/company/axiomatetechservices" target="_blank" class="text-[0.85rem] text-gray-400 hover:text-[#00d2ff] transition-colors duration-300">LinkedIn</a>
              ...
              <a href="mailto:support@axiomate.in" class="text-[0.85rem] text-gray-400 hover:text-[#00d2ff] transition-colors duration-300">Email Us</a>
            </div>
          </div>
