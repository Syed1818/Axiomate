    ...
    if (!transitionOverlay) {
      ...
      transitionOverlay.innerHTML = `
        <div class="transition-content">
          <img src="/images/logo.png" alt="Axiomate" class="transition-icon" />
          <div class="transition-text">ESTABLISHING LINK</div>
          <div class="transition-bar"><div class="transition-progress"></div></div>
        </div>
      `;
